...
ActiveRecord::Schema.define(version: 20150507084018) do
  ...
  create_table "cars", force: :cascade do |t|
    t.string   "plate",           default: "ABC-123", null: false
    t.date     "lastvisit"
  ...
  add_index "cars", ["parkinghouse_id"], name: "index_cars_on_parkinghouse_id"
